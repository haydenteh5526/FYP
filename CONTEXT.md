...
```bash
# Backend — 129 tests at the 2026-09-14 baseline.
...
|-------|--------|
| main CI | success |
| Backend | ruff clean · **129** pytest pass · 67.69% coverage (65% floor) |
...
Use the priority-ordered root `TODO.md`. In summary: configure a real Q&A
provider, execute the frozen evaluation protocol,
